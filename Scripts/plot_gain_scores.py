...
def plot(ax, filename, growthes, add_legend, header=None, x_axis_label=None, y_axis_label=None):
    ax.hist(growthes, density=True, bins=16) # setting density to False will show count, and True will show probability.
    ax.set_yscale('log')
...
def set_plot_style(nrows, ncols):
    ...
    fig, axes = plt.subplots(nrows=nrows, ncols=ncols, figsize=(12, 12), dpi=300)
